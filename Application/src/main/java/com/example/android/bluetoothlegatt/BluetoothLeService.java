...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            Log.d(TAG,"onCharacteristicChanged e girdi");
        }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt,
            ...
            Log.d(TAG,"OnWriteCharacteristic e girdi");
            // do somethings here.
        }
    };
    ...
    private void broadcastUpdate(final String action,
        ...
        data = characteristic.getValue();
            if(data != null)
            {
                data_int = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16,0);
            }


            String dataStr = String.valueOf(data_int);
        if (data != null && data.length > 0) {

            intent.putExtra(EXTRA_DATA, new String(dataStr));
...
//        }
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        if (mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter connection characteristic");
            return;
        }
